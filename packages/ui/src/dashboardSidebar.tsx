...
export function DashboardSidebar({LinkComponent}: {LinkComponent: any}) : JSX.Element{
    return (
        <aside className="fixed top-16 left-0 h-screen w-54 pt-6 bg-zinc-200">
            <div className="w-full">
                <ul className="space-y-6 text-sm font-semibold">
                    <li className="flex place-items-center p-2 pl-12 hover:cursor-pointer hover:text-purple-800 hover:bg-zinc-100 hover:rounded-sm">
                        <LinkComponent href="/dashboard" className="flex space-x-2">
                    ...
                    <li className="flex place-items-center space-x-2 p-2 pl-12 hover:cursor-pointer hover:text-purple-800  hover:bg-zinc-100 hover:rounded-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5">
                    ...
                    <li className="flex place-items-center space-x-2 p-2 pl-12 hover:cursor-pointer hover:text-purple-800  hover:bg-zinc-100 hover:rounded-sm">
                        <LinkComponent href="/transfer" className="flex space-x-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5">
                    ...
                    <li className="flex place-items-center p-2 pl-12 hover:cursor-pointer hover:text-purple-800 hover:bg-zinc-100 hover:rounded-sm">
                        <LinkComponent href="/peer-tranx" className="flex space-x-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M15 8.25H9m6 3H9m3 6-3-3h1.5a3 3 0 1 0 0-6M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                            </svg>
                            <span>Pay Friends</span>
                        </LinkComponent>
                    </li>
                </ul>
            </div>
